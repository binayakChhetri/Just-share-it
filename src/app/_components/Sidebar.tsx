...
const Sidebar = () => {
  return (
    <aside className="flex h-screen w-30 flex-col justify-between border-e border-gray-100 bg-white row-span-full">
      <div>
            ...
            <ul className="space-y-1 border-t border-gray-100 pt-4">
              ...
              <li>
                ...
                >
                  ...
                  <span classame="invisible absolute start-full top-1/2 ms-4 -translate-y-1/2 rounded-sm bg-gray-900 px-2 py-1.5 text-xs font-medium text-white group-hover:visible">
                    Invoices
                  </span>
                </a>
              </li>
